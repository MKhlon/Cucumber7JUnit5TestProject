...
public class DataTableSteps {
    ...
    public void i_placed_an_order_for_the_following_items(io.cucumber.datatable.DataTable dataTable) {
        //List of Strings
        List<String> billDataList = dataTable.asList(String.class);
        for (String billItem: billDataList) {
            System.out.println(billItem);
        }

        //List of Lists of Strings
        List<List<String>> billDataListOfLists = dataTable.asLists(String.class);

        for(List<String> billItems:billDataListOfLists) {
